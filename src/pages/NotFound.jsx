...
export default function NotFound() {
  return (
    <Container className="flex min-h-[70vh] flex-col items-center justify-center py-24 text-center">
      <p className="font-display text-8xl font-bold text-ink-900/10">404</p>
      <h1 className="mt-2 font-display text-3xl font-bold text-ink-900">Looks like this trail isn't mapped</h1>
