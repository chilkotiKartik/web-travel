  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="absolute right-3 top-3 rounded-full bg-white/95 px-3 py-1 text-xs font-semibold text-navy-950">
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <h3 className="mt-1 font-display text-lg font-semibold leading-snug text-navy-950">{tour.title}</h3>
        ...
        <div className="mt-auto flex items-end justify-between pt-4">
          <div>
            ...
            <p className="font-display text-lg font-bold text-navy-950">{formatPrice(tour.price)}</p>
          </div>
          <span className="rounded-full bg-navy-900/5 px-3 py-1.5 text-xs font-semibold text-navy-950 transition-colors group-hover:bg-green-500 group-hover:text-navy-950">
            View Details
          </span>
        </div>
      </div>
